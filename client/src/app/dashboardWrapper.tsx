...
const DashboardLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  }, [isDarkMode]); // ✅ Added dependency array to avoid unnecessary re-renders
...
// Step 3: passed children in the dashboardWrapper in layout.tsx
...
//   );
// }
// Here, you’re unintentionally creating two separate StoreProvider instances, which could mean:
...
//   );
// }
// MAIN POINT::::::: THE ROOT OF THE LAYOUT EXISTS OVER in the layout.tsx so we had to use as there is no way of controlling the root: useclient
